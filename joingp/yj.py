...
for index, row in df.iterrows():
	...
	print(row['code'][0:11],display_name,row['market_cap'], row['circulating_market_cap'],basic_eps,operating_revenue,row['adjusted_profit'],row['pubDate'],row['statDate'],account_receivable,advance_payment,bsstart_date,net_operate_cash_flow,net_invest_cash_flow,net_finance_cash_flow)
